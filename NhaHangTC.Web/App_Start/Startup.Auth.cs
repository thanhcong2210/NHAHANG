...
namespace NhaHangTC.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(NhaHangTCDbContext.Create);
            app.CreatePerOwinContext<TaiKhoanManager>(TaiKhoanManager.Create);
            app.CreatePerOwinContext<ApplicationSignInManager>(ApplicationSignInManager.Create);
            //app.CreatePerOwinContext<UserManager<TaiKhoanUser>>(CreateManager);
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                Provider = new CookieAuthenticationProvider
                {
                    ...
                    OnValidateIdentity = SecurityStampValidator.OnValidateIdentity<TaiKhoanManager, TaiKhoanUser>(
